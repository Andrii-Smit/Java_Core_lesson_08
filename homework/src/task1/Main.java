...
public class Main {
	static void menu() {
		System.out.println(" ¬вед≥ть 0, щоб перев≥рити чи Ї такий м≥с€ць ");
		System.out.println(" ¬вед≥ть 1, щоб вивести вс≥ м≥с€ц≥ з такою ж порою року ");
		System.out.println(" ¬вед≥ть 2, щоб вивести вс≥ м≥с€ц≥ €к≥ мають таку саму к≥льк≥сть дн≥в ");
		System.out.println(" ¬вед≥ть 3, щоб вивести на екран вс≥ м≥с€ц≥ €к≥ мають меншу к≥льк≥сть дн≥в ");
		System.out.println(" ¬вед≥ть 4, щоб вивести на екран вс≥ м≥с€ц≥ €к≥ мають б≥льшу к≥льк≥сть дн≥в ");
		System.out.println(" ¬вед≥ть 5, щоб вивести на екран наступну пору року ");
		System.out.println(" ¬вед≥ть 6, щоб вивести на екран попередню пору року ");
		System.out.println(" ¬вед≥ть 8, щоб вивести на екран вс≥ м≥с€ц≥ €к≥ мають непарну к≥льк≥сть дн≥в ");
		System.out.println(" ¬вед≥ть 9, щоб вивести на екран чи введений з консол≥ м≥с€ць маЇ парну к≥льк≥сть дн≥в ");
	}
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 0: {
				System.out.println(" ѕрограма перев≥рки ≥снуванн€ введеного м≥с€ц€ ");
				...
				if (flag == true) {
					...
					System.out.println(" ¬ведений м≥с€ць не ≥снуЇ ");

				break;
			}

			case 1: {
				System.out.println(" ѕрограма виведенн€ вс≥х м≥с€ц≥в з введеною порою року ");
			...
			case 2: {
				System.out.println(" ѕрограма виведенн€ вс≥х м≥с€ц≥в з введеною к≥льк≥стю дн≥в ");
			...
			case 3: {
				System.out.println(" ѕрограма виведенн€ вс≥х м≥с€ц≥в з к≥льк≥стю дн≥в менше введеного ");
				System.out.println(" ¬вед≥ть к≥льк≥сть дн≥в: ");
				...
				if (flag == true) {
					System.out.println("  ≥льк≥сть дн≥в менше " + numberOfDays4 + " в наступних м≥с€ц€х: ");
			...
			case 4: {
				System.out.println(" ѕрограма виведенн€ вс≥х м≥с€ц≥в з к≥льк≥стю дн≥в б≥льше введеного ");
				System.out.println(" ¬вед≥ть к≥льк≥сть дн≥в: ");
				...
				if (flag == true) {
					System.out.println("  ≥льк≥сть дн≥в б≥льше " + numberOfDays5 + " в наступних м≥с€ц€х: ");
			...
			case 5: {
				System.out.println(" ѕрограма виведенн€ наступноњ пори року ");
				System.out.println(" ¬вед≥ть пору року: ");
			...
			case 9: {
				System.out.println(" ѕрограма перев≥рки парноњ к≥лькост≥ дн≥в у введеному м≥с€ц≥ ");
				System.out.println(" ¬вед≥ть м≥с€ць: ");
				...
				if (flag == true) {
					...
					if (month.getNumberOfDays() % 2 == 0) {
						System.out.println("  ≥льк≥сть дн≥в у м≥с€ц≥ " + month0 + " - " + month.getNumberOfDays()
								+ ". ÷е число - парне ");
					} else {
						System.out.println("  ≥льк≥сть дн≥в у м≥с€ц≥ " + month0 + " - " + month.getNumberOfDays()
								+ ". ÷е число - непарне ");
